    ...
    <>
      <div className='container about-page'>
        <div className='text-zone'>
          ...
          <p>
            I'm very ambitious full-stack developer looking for a role in established IT
          ...
          <p>
            If I need to define myself in one sentence that would be a family person, a sports
        ...
        <div className='stage-cube-cont'>
          <div className='cube-spinner'>
            <div className='face1'>
              <FontAwesomeIcon icon={faGolang} color='#00CCFF' />
            </div>
            <div className='face2'>
